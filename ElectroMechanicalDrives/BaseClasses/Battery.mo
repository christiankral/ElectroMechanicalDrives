...
partial model Battery "Partial re-chargeable battery with internal resistor"
  ...
  final parameter Modelica.Units.SI.Capacitance
    CCell=2*ECell/(V1Cell^2 - V0Cell^2) "Total charge of battery";
  parameter Modelica.Units.SI.Resistance RCell "Cell resistance";
