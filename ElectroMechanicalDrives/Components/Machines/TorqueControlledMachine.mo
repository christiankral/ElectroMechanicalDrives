...
equation
  ...
  connect(speedMachineSensor.flange, torqueMachineSensor.flange_a) annotation (Line(points={{-30,-10},{-30,0},{0,0}}, color={0,0,0}));
  ...
  annotation(defaultComponentName = "machine", Diagram(coordinateSystem(preserveAspectRatio=false,   extent={{-100,-100},{100,100}})),
    Icon(coordinateSystem(preserveAspectRatio = false, extent = {{-100, -100}, {100, 100}}), graphics={  Rectangle(origin = {90, 0}, lineColor = {64, 64, 64}, fillColor = {191, 191, 191},
      fillPattern = FillPattern.HorizontalCylinder, extent = {{-10, -10}, {10, 10}}),
