...
model TestIdealBattery
  ...
  Components.Electrical.IdealBattery battery(V1Cell = 4, V0Cell = 3, ECell = 1188E3, ns = 10, np = 1, ViniCell = 4) annotation(Placement(transformation(extent = {{-10, -10}, {10, 10}}, rotation = 270, origin = {-40, 0})));
