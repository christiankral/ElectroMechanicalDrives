...
model TestBattery
  ...
  Components.Electrical.Battery battery(V1Cell = 4, V0Cell = 3, ECell = 1188E3, ns = 10, np = 1, ViniCell = 4, RCell = 0.45E-3) annotation(Placement(transformation(extent = {{-10, -10}, {10, 10}}, rotation = 270, origin = {-40, 0})));
...
equation
  ...
  annotation(Diagram(coordinateSystem(preserveAspectRatio = false, extent = {{-100, -100}, {100, 100}}), graphics), experiment(StopTime = 3600));
end TestBattery;
