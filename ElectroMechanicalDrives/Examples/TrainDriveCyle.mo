...
model TrainDriveCyle "Test of drive cycle of railjet"
  ...
  ElectroMechanicalDrives.Components.Vehicles.Vehicle locomotive(
    ...
    cx=0.5,
    m=21500,
    constantAngle=0) annotation (Placement(transformation(extent={{50,-10},{70,10}})));
...
equation
  ...
  connect(forceSensor.flange_b, locomotive.flangeT_a) annotation (Line(
      ...
      color={0,127,0},
      smooth=Smooth.None));
  connect(locomotive.flangeT_b, wagons.flangeT_a) annotation (Line(
      points={{70,4.44089e-16},{70,0},{80,0},{80,6.66134e-16}},
      color={0,127,0},
      smooth=Smooth.None));
