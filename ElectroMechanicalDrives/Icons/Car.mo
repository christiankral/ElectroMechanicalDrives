...
model Car "Car icon"
  ...
  annotation(Icon(graphics={  Polygon(points={{100,-40},{100,10},{80,20},{50,20},{20,80},{-80,80},{-100,20},{-100,-40},{100,-40}},                       lineColor = {0, 0, 0},
            fillPattern =                                                                                                   FillPattern.Sphere, smooth = Smooth.None, fillColor = {128, 128, 128}),
                                                                                                                                                                              Polygon(points={{42,18},{14,74},{-6,74},{-6,18},{42,18}},             lineColor = {0, 0, 0},
